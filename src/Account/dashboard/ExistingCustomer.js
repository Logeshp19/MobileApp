            ...
            <View >
                ...
                <View >
                    ...
                    <View style={{ flexDirection: 'row' }}>
                        <Text style={[styles.dropdowntitle, { justifyContent: 'flex-start' }]}>Existing Customer </Text>
                    </View>
                    ...
                    <Animatable.View animation="fadeInUp" duration={1000} delay={300}>
                        <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                            ...
                            />
                            <Dropdown
                                style={[styles.dropdownmain, { marginTop: 6 }]}
                                data={customerSegmentOptions}
                                labelField="label"
                                valueField="value"
                                placeholder="Select segment"
                                value={customerSegment}
                                onChange={item => setCustomerSegment(item.value)}
                                placeholderStyle={{ color: '#c6c4c4ff', fontSize: 11.5 }}
                                selectedTextStyle={{ fontSize: 11.5 }}
                                itemTextStyle={{ fontSize: 12 }}
                            />
